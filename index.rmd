...
---
title: "Perth Airport Rainfall Analysis 🛫"
output:
  html_document:
    toc: true
    toc_depth: 2
...
Running a second model, we can estimate that Perth would cease to have any rainfall in 89 years. Of course, it is doubtful that the trend will continue towards zero forever as climate is rarely so simple!
